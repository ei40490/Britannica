...
<body>
    ...
    <div class="container">
		<div class="contact-box">
            ...
            <input name="firstname" id="firstname" class="inputet"  placeholder="Emri">
            ...
            <textarea name="mesazhi" id="mesazhi" placeholder="Mesazhi" class="inputet" ></textarea>
            <input id="lloji" type="radio" name="lloji" value="Kerkese"/>Kerkese
            <input id="lloji" type="radio" name="lloji" value="Ankese"/>Ankese
